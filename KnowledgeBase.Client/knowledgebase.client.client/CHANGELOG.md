...
- Create Angular project with ng: `ng new knowledgebase.client.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`knowledgebase.client.client.esproj`).
